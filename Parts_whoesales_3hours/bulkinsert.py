...
class c_bulk_insert:
    ...
    def insert_data(self, conn, csv_file_nm, db_table_nm):
        ...
        qry = "BULK INSERT " + db_table_nm + " FROM '" + csv_file_nm + "' WITH (DATA_SOURCE = 'dwhwebstorage_test', FIELDTERMINATOR =',', FORMAT = 'CSV', DATAFILETYPE ='char', ROWTERMINATOR = '0x0a', CODEPAGE = '65001')"
        # Execute the query
        # cursor = conn.cursor()
        # if encoding == 'cp874':
