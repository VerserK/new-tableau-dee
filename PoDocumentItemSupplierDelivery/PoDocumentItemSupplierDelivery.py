...
def run():
    ...
    df['PRItemId'] = df['PRItemId'].fillna(9933)
    df['PRItemId'] = df['PRItemId'].astype(int)
    df['PRItemId'] = df['PRItemId'].replace(9933,None)
    df['PRItemNo'] = df['PRItemNo'].fillna(9933)
    df['PRItemNo'] = df['PRItemNo'].astype(int)
    df['PRItemNo'] = df['PRItemNo'].replace(9933,None)
    df = df[df.columns[:-1]]
